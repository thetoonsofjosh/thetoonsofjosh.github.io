jQuery(document).ready(function($) {
	...
	if (!FlashDetect.installed) {
		...
		soundManager.onready(function() {
			//First screen load
			if(typeof parent.GA_obj != 'undefined'){ parent.GA_obj.trackPageview('/survey/2011/gender/'); }
		...
		$(".surveyGenderOptions li").each(function(){
			$(this).click(function(){
				...
				if(typeof parent.GA_obj != 'undefined'){
 							parent.GA_obj.trackPageview('/survey/2011/age/?gender=' + surveyAnswerGender + '&path=' + parent.location.pathname);
	 			}
	...
	if($(".surveyAgeOptions").length != 0) {
		...
		function advanceToEpilogue() {
			...
			if(typeof parent.GA_obj != 'undefined'){
 							parent.GA_obj.trackPageview('/survey/2011/complete/?' + result);
 						}
