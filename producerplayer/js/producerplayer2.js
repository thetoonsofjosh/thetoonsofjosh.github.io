(function(){
  ...
  var _CDN   = _DEBUG ? "/" : "thetoonsofjosh.github.io";
  ...
  //var _EMPTY_GIF = "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==";//transparent 1x1 gif
  ...
  var _supportsSVG = document.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image", "1.1") ? true : false;
  ...
  var _deps = [
    {
      ...
      src: _CDN + "pbsk/video/lib/jquery.pbskidsvideo." + (_DEBUG ? "" : "min-") + "latest.js",
      test: function(){
  ...
  ****************************/
  ...
  function _addPlaylistController(){
    ...
    if( _player.isStationPlayer() || _bannerDisplay){
      $.ajax({
        url: "http://pbskids.org/pbsk/video/api/getCategories/",
        dataType:"jsonp",
        success : function(response){
          _topics = response.items;
          $.ajax({
            url: "http://pbskids.org/pbsk/video/api/getShows/",
            dataType:"jsonp",
  ...
  ****************************/
  function _validateConfig(config){
    ...
    config.playerColorScheme = config.playerColorScheme || "/producerplayer/colorschemes/go-scheme.xml";
    config.releaseListColorScheme = config.releaseListColorScheme || "/producerplayer/colorschemes/go-scheme.xml";
