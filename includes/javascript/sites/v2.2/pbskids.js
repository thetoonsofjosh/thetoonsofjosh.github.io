...
(function() {
    var loader_attributes = {
        ...
        _initPossibleDependencies: function () {
            ...
            'name': 'video-api',
            'type': 'js',
            'src': this.cdn_base +  '/pbsk/video/lib/pbskvideo.js',
            'callback': function(){
            }		
            }, 
            ...
            'name': 'go-video',
            'type': 'js',
            'src': this.cdn_base +  '/go/js/scripts-video.js',
            'callback': function(){
            }		
            }, 
            ...
            'callback': function(){
                ...
                $.ajax({'url': '/homepage/sponsorship/campaign/' + campaign_slug + '.json',
                    'async': false,
                    'dataType': 'json',
...

        {
            'name': 'jqxcore',
            'type': 'js',
            'src': this.cdn_base +  '/go/js/jqxcore.js',
            'callback': function(){
            }		
        }, 
        {
            'name': 'jqxbuttons',
            'type': 'js',
            'src': this.cdn_base +  '/go/js/jqxbuttons.js',
            'callback': function(){
            }		
        }, 

        {
            'name': 'jqxscrollbar',
            'type': 'js',
            'src': this.cdn_base +  '/go/js/jqxscrollbar.js',
            'callback': function(){
            }		
        }, 
        {
            'name': 'go-scripts',
            'type': 'js',
            'src': this.cdn_base +  '/go/js/scripts.js',
            'callback': function(){
            }		
        }, 
        ...
        _loadJS: function (src, callback) {
            ...
            // IE7 disrespects differences in readyState
            if ((PBS.KIDS.ieVersion <= 7) && (PBS.KIDS.ieVersion != -1)) {
                js.onreadystatechange = function () {
                    if (callback) {
                        callback();
                    }
                }
            } else if (PBS.KIDS.ieVersion == 8) {
                js.onreadystatechange = function () {
