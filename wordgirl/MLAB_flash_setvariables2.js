...
//	}else{
		...
		var divinfo = "<embed src='http://pbskids.org/_/wordgirl/gateway.swf' base='http://pbskids.org/_/wordgirl/' allowScriptAccess='always' FlashVars='lc="+movieid+"&fq="+escape(flashquery)+"' width='0' height='0' type='application/x-shockwave-flash'></embed>";
